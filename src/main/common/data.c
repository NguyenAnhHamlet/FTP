               ...
               char* file_name, int n_len, endpoint_type type)
{
    ...
    case CLIENT:
    {
        ...
        {
            LOG("Server file is older than local file\n 
                Abort the operation\n");
        ...
        {
            LOG("Fail to open data connection\n");
            return 0;
        }
               ...
               char* file_name, int n_len, endpoint_type type)
{
    ...
    case CLIENT:
    {
        ...
        {
            LOG("Remote file has smaller size than local. Abort\n");
            return 0;
        }

        if(!get(c_channel, d_channel,file_name, &n_len, CLIENT))
        {
            LOG("Failed to get file from remote server\n");
            return 0;
        }
